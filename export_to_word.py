# -*- coding: utf-8 -*-
"""
export_to_word.py — セミナー読み原稿をWord形式に変換
"""
import sys, os, re
...
MD_PATH = os.path.join(SCRIPT_DIR, "seminar_script.md")
OUT_PATH = os.path.join(SCRIPT_DIR, "セミナー読み原稿.docx")
...
for line in lines:
    ...
    # H1 (# で始まるセクションタイトル)
    if line.startswith('# 第') or line.startswith('# 補足') or line.startswith('# 原稿'):
        doc.add_page_break()
